        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="position-center">
                    ...
                    <form role="form" action="<?php echo BASE_URL ?>CategorysController/AddCategory" method="post"> 
                       
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="InputDanhmuc">Tên danh mục</label>
                                    <input type="text" name="category_name" class="form-control inputform" id="InputDanhmuc" placeholder="Tên Danh Mục">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="InputSlug">Slug</label>
                                    <input type="text" name="category_slug" class="form-control inputform" id="InputSlug" placeholder="Tên Slug Danh Mục">
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea style="resize: none" rows="4" class="form-control inputform" name="category_desc" id="editor2" placeholder="Mô Tả Danh Mục"></textarea>
