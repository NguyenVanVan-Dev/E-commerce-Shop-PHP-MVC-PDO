                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="<?php echo BASE_URL ?>ProductsController/AddProduct" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        class="form-control" id="exampleInputEmail4" placeholder="Giá Sản Phẩm(number)">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none"  rows="8" class="form-control" name="product_desc" id="editor3" placeholder="Mô tả sản phẩm"></textarea>
                                    <script>
